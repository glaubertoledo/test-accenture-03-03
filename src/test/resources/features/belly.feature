# language: pt
@RecebeEmail
Funcionalidade: dsdsasadsa asdasdasda
  ...
  Esquema do Cenario: Preencher o formulario e enviar um email com sucesso
    ...
    Exemplos: 
      | make   | model     | cylindercapacity | kw    | dateofmanufacture | numberofseats | numberofseats2 | fuel  | payload | totalweight | listprice | annualmileage | firstName | lastname | birthdate    | country  | zipcode    | occupation | stardate     | valorInsuannce | meritRating   | dmgInsurance    | optionalProducts | cortesycar | priceOption | email                 | username  | password   | confirmpassword |
      | "Audi" | "Scooter" | "025"            | "021" | "06/03/1995"      |             2 |              2 | "Gas" | "100"   | "1000"      | "500"     | "500"         | "Glauber" | "Toledo" | "06/03/1995" | "Brazil" | "74565060" | "Farmer"   | "06/03/2023" | "3.000.000,00" | "Super Bonus" | "Full Coverage" |                3 | "Yes"      | "Ultimate"  | "glauber@hotmail.com" | "glauber" | "Teste@01" | "Teste@01"      |
